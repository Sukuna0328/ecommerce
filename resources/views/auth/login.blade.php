			...
			<div class="card-body">
				<form method="POST" action="{{ route('login') }}">
					...
					<div class="input-group form-group">
						...
						<input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="username">
                        @error('email')
                        <span >
...
{{-- <section class="vh-100 bg-image"
  style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYCYWj2gDBgr9ON1HnNvHBCH1HgYyo19_sFg&s');"> --}}
      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="card style=border-radius: 15px;">
                ...
                <div class="card-header" class="btn btn-primary Login">{{ __('Login') }} 
